...
def main():
    ...
    parser.add_argument('--answers', '-a',
                        default="Backdoor/models/Clone_Detection/BigCloneBench/UniXCoder/poisoned_func_name_postfix_rb_True/checkpoint-best-f1/predictions_clean.txt",
                        help="filename of the labels, in txt format.")
    parser.add_argument('--predictions', '-p',
                        default="Backdoor/dataset/Clone_Detection/BigCloneBench/test.txt",
